/**
 * Live MCP transports for Clio (F6a) over the official MCP SDK.
 *
 * Implements the pure McpClient interface from clio-mcp.helpers.ts with two
 * transports:
...
import { parseMcpToolsList, type McpClient, type McpToolDescriptor } from './clio-mcp.helpers.js';
