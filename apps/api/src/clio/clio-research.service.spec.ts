...
/**
 * Unit test for the FORCED-SYNTHESIS fallback in ClioResearchService.
 *
...
function makePrisma() {
  ...
  } as unknown as ConstructorParameters<typeof ClioResearchService>[0];
}
...
function makeTools() {
  ...
  } as unknown as ConstructorParameters<typeof ClioResearchService>[2];
}

// ── Test ─────────────────────────────────────────────────────────────────────

describe('ClioResearchService — forced synthesis', () => {
  ...
  it('does NOT make a forced-synthesis call when the model already wrote prose', async () => {
    const REPORT = '# Executive Summary\n\nClio produced this report inline during the loop.';
