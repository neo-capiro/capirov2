...
export const billAnalysisSkill: ClioSkill = {
  id: 'bill_analysis',
  name: 'Bill Analysis',
...
export const hearingPrepSkill: ClioSkill = {
  id: 'hearing_prep',
  name: 'Hearing Prep',
...
export const coalitionLetterSkill: ClioSkill = {
  id: 'coalition_letter',
...
export const amendmentTrackerSkill: ClioSkill = {
...
export const LOBBYING_SKILLS: readonly ClioSkill[] = [
  billAnalysisSkill,
  hearingPrepSkill,
