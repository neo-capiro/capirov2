/**
 * Clio skill registry types (P0-5, keystone).
 *
 ...
 * composable filesystem modules under clio/skills/ instead of being hardcoded
 * inline in clio.service.ts. The registry is the source of truth for migrated
...
export interface ClioSkillTemplate {
...
export interface ClioSkill {
  ...
  template: ClioSkillTemplate | null;
}
