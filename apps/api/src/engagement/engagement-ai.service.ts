...
export class EngagementAiService {
  ...
  private buildOutreachPrompt(input: OutreachDraftInput): string {
    const workflowGuidance = {
      campaign:
        'Draft a campaign email for many congressional recipients. Keep {district}, {committee}, and {personal_note} placeholders when useful, and preserve {member_priority} if already present. Do not invent recipient-specific facts not present in the supplied recipient context.',
      follow_up:
