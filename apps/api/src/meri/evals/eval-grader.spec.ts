...
import type { MeriEvalExpect, MeriEvalFixture, MeriEvalGrade } from './eval.types.js';

function fixture(
  expect: Partial<MeriEvalExpect>,
  over: Partial<MeriEvalFixture> = {},
): MeriEvalFixture {
  return {
    id: over.id ?? 'fx-1',
