/**
 * Pure grading logic for the Meri eval harness (P1-1).
 *
 ...
 */
import type { MeriEvalFixture, MeriEvalGrade, MeriEvalSummary } from './eval.types.js';
...
export function isGrounded(grade: MeriEvalGrade, threshold: number): boolean {
...
export function summarizeGrades(grades: MeriEvalGrade[], threshold = 0.2): MeriEvalSummary {
  ...
  const bySkill: MeriEvalSummary['bySkill'] = {};
