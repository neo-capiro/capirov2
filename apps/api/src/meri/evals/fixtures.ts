/**
 * Meri eval fixtures (P1-1). Committed Q&A items scoped by skill.
 *
 ...
 */
import type { MeriEvalFixtureInput } from './eval.types.js';

export const CLIO_EVAL_FIXTURES: MeriEvalFixtureInput[] = [
  // ─────────────────────────── research (grounded) ───────────────────────────
  {
