/**
 * Meri document generation service.
 *
 * Turns a normalized document spec (see meri-docgen.helpers.ts) into a real
...
@Injectable()
export class MeriDocgenService {
  private readonly logger = new Logger(MeriDocgenService.name);
